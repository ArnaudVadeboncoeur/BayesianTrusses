...
public:
    ...
    PdfEval ( Eigen::MatrixXd empStdCovMatrix, Eigen::MatrixXd trueSampleDisp,  std::vector<int> paraIndex ,Eigen::VectorXi ObsIndex,
...
private:
    ...
    Eigen::MatrixXd empStdCovMatrix_;
...
template < unsigned DimObs, unsigned DimPara, typename Vec >
PdfEval < DimObs, DimPara, Vec>::PdfEval( Eigen::MatrixXd empStdCovMatrix, Eigen::MatrixXd trueSampleDisp, std::vector<int> paraIndex,
                                          Eigen::VectorXi ObsIndex, Vec priorMean,
                                          const Eigen::MatrixXd& PriorCovMatrix ){

    empStdCovMatrix_ = empStdCovMatrix;
...
//        }}
    ...
    CovMatrixNoise = empStdCovMatrix_;
